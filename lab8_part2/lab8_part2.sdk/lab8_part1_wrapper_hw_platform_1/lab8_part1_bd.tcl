...
################################################################
# This is a generated script based on design: lab8_part1
#
...
proc create_root_design { parentCell } {
  ...
  set transmitted_bits_1 [ create_bd_port -dir O -from 3 -to 0 transmitted_bits_1 ]
  set tx [ create_bd_port -dir O tx ]

  # Create instance: UARTmodule2017winter_0, and set properties
  set UARTmodule2017winter_0 [ create_bd_cell -type ip -vlnv rose-hulman.edu:user:UARTmodule2017winter:1.0 UARTmodule2017winter_0 ]

  # Create instance: axi_gpio_0, and set properties
  set axi_gpio_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_0 ]
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_ALL_OUTPUTS_2 {1} CONFIG.C_GPIO2_WIDTH {1} CONFIG.C_GPIO_WIDTH {8} CONFIG.C_IS_DUAL {1}  ] $axi_gpio_0

  # Create instance: axi_gpio_1, and set properties
  set axi_gpio_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_1 ]
  set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_GPIO_WIDTH {1}  ] $axi_gpio_1
...
CONFIG.PCW_ENET0_RESET_ENABLE {0} CONFIG.PCW_ENET1_PERIPHERAL_ENABLE {0} \
...
CONFIG.PCW_I2C1_PERIPHERAL_ENABLE {1} CONFIG.PCW_MIO_0_PULLUP {<Select>} \
...
CONFIG.PCW_USE_M_AXI_GP0 {1}  ] $processing_system7_0
  ...
  connect_bd_net -net UARTmodule2017winter_0_transmitted_bits [get_bd_ports transmitted_bits_1] [get_bd_pins UARTmodule2017winter_0/transmitted_bits]
  connect_bd_net -net UARTmodule2017winter_0_tx [get_bd_ports tx] [get_bd_pins UARTmodule2017winter_0/tx]
  connect_bd_net -net UARTmodule2017winter_0_tx_full [get_bd_pins UARTmodule2017winter_0/tx_full] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins UARTmodule2017winter_0/write_to_uart] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins UARTmodule2017winter_0/tx_data] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins UARTmodule2017winter_0/clock] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins UARTmodule2017winter_0/reset] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  ...
  connect_bd_net -net rx_1 [get_bd_ports rx] [get_bd_pins UARTmodule2017winter_0/rx]
