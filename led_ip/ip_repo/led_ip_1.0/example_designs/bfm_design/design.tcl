proc create_ipi_design { offsetfile design_name } {
	...
	set led_ip_0 [ create_bd_cell -type ip -vlnv rose-hulman.edu:user:led_ip:1.0 led_ip_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores rose-hulman.edu:user:led_ip:1.0]]]]
