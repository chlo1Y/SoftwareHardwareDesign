...
################################################################
# This is a generated script based on design: lab10VGAdemoZSY
#
...
# source lab10VGAdemoZSY_script.tcl
...
set design_name lab10VGAdemoZSY
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.c_include_s2mm {0} CONFIG.c_mm2s_genlock_mode {1} CONFIG.c_mm2s_linebuffer_depth {2048} CONFIG.c_mm2s_max_burst_length {16} CONFIG.c_s2mm_genlock_mode {0} CONFIG.c_use_mm2s_fsync {1}  ] $axi_vdma_0
...
CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {100} CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {150} \
...
CONFIG.PCW_USE_AXI_NONSECURE {0} CONFIG.PCW_USE_S_AXI_GP0 {0} \
