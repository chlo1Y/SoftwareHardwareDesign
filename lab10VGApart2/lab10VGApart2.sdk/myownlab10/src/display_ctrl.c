...
/***	DisplayInitialize(DisplayCtrl *dispPtr, u16 vdmaId, u32 dispCtrlAddr, u32 *framePtr[DISPLAY_NUM_FRAMES], u32 stride)
**
**	Parameters:
...
**
*/
int DisplayInitialize(DisplayCtrl *dispPtr, u16 vdmaId, u32 dispCtrlAddr, u32 *framePtr[DISPLAY_NUM_FRAMES], u32 stride)
{
	int Status;
	int i;
