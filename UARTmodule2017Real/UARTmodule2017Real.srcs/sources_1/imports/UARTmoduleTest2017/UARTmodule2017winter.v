...
module UARTmodule2017winter(rx, tx, tx_full, rx_data_present, read_from_uart, write_to_uart, 
...
always@(posedge clock)
 transmitted_bits<=tx_data;
	...
	BaudRateGenerator BaudRateUnit(en_16_x_baud, resetNot, clock, BAUDRATE, FREQUENCY);

wire read_one_shot, write_one_shot;
//module ClockedOneShot(InputPulse, OneShot, Reset, CLOCK) ;
ClockedOneShot ReadOneShotUnit(read_from_uart, read_one_shot, resetNot, clock) ;

ClockedOneShot WriteOneShotUnit(write_to_uart, write_one_shot, resetNot, clock) ;
