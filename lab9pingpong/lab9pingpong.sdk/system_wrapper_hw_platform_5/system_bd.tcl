...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_INTERRUPT_PRESENT {1} CONFIG.GPIO_BOARD_INTERFACE {btns_4bits} CONFIG.USE_BOARD_FLOW {true}  ] $buttons

  # Create instance: led_ip, and set properties
  set led_ip [ create_bd_cell -type ip -vlnv rose-hulman.edu:user:led_ip:1.0 led_ip ]
...
CONFIG.PCW_GPIO_MIO_GPIO_ENABLE {0} CONFIG.PCW_IRQ_F2P_INTR {1} \
...
CONFIG.PCW_MIO_2_SLEW {fast} CONFIG.PCW_MIO_30_PULLUP {<Select>} \
...
CONFIG.PCW_MIO_39_SLEW {<Select>} CONFIG.PCW_MIO_3_SLEW {fast} \
...
CONFIG.PCW_MIO_8_SLEW {fast} CONFIG.PCW_MIO_9_PULLUP {<Select>} \
...
CONFIG.PCW_USB0_RESET_IO {<Select>} CONFIG.PCW_USE_FABRIC_INTERRUPT {1} \
CONFIG.PCW_USE_M_AXI_GP0 {1}  ] $processing_system7_0
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_GPIO_WIDTH {4} CONFIG.C_INTERRUPT_PRESENT {0} CONFIG.GPIO_BOARD_INTERFACE {sws_4bits}  ] $switches
  ...
  connect_bd_net -net M01_ARESETN_1 [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_reset]
